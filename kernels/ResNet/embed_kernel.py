...
# Embed Layer for SDXL is a SiLu activation, Feed Forward
import torch
...
def embed_kernel(x: torch.Tensor, w1: torch.Tensor, w3: torch.Tensor) -> torch.Tensor:
...
if __name__ == "__main__":
    ...
    output_triton = embed_kernel(x=x, w1=w1_w, w3=w3_w)
    ...
    print("rms matmul silu mul triton", triton.testing.do_bench(lambda: embed_kernel(x=x, w1=w1_w, w3=w3_w)))
