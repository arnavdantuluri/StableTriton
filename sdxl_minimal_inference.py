...
assert TORCH2_AVAILABLE, "Torch 2.0 needs to be available to compile tokenizer and auto encoder models, please install 2.0."
...
if __name__ == "__main__":
    ...
    text_model1 = torch.compile(text_model1)
    text_model2 = torch.compile(text_model2)
    vae = torch.compile(vae)
    text_projection = torch.compile(text_projection)
